...
<body>
    <div class="container">
        <h1>Premium<b style="color:purple"> Rs.4,999</b></h1>
        <br><br>
        <form id="payment-form" action='./success2.php' method='POST'>        
    ...
    <script>
        function fn() {
            ...
            if(confirm("Press OK to confirm the payment of Rs.4,999")){
                return true;
            }
            return false;
        }
