...
<body>
    <div class="container">
        ...
        <div class="form-group">
                <label style='color : green;' for="i1">User Name</label>
                <?php
            ...
            <div class="form-group">
                <label style='color : green;'for="i1">Email Id</label>
                <?php
            ...
            <div class="form-group">
                <label style='color : green;' for="i2">Password</label>
        ...
        <p >if already logged in then <a href='./login.php'><b>Log In</b></a><p>
    </div>
</body>
</html>