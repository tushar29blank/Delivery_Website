...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <section>
        <br><br><br>
<!--below means that all those classes are applied in it--> 
      <div class="container grid grid--2-cols margin-bottom-md">
          <div class="princing-plan princing-plan--starter">
            ...
            <br><br>
            <p style='text-Align:center;'><a  href="./notpaid.php" class="btn btn--form">Cancel Your Plan</a></p> <!-- this class="btn btn--form" means that 2 clases are being applied to the tag-->
          </div>
          ...
          <div class="princing-plan princing-plan--complete">
            ...
            <div class="plan-sing-up">
              <a href="./pay2.php" class="btn btn--full">UPGRADE</a>
            </div>
          </div>
        </div>
          ...
          <div class="feature">
            ...
            <p class="feature-text">
              ...
              unused days.
                ...
                <div><a href="./logout.php" class="btn btn--form" >Logout</a></div>
            </div>
      </section>
    </main>
